package com.fx.springcloud.service.impl;

import com.fx.springcloud.domain.User;
import com.fx.springcloud.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public void initData() {
        ...
        userList.add(new User(1L, "cw", "123456"));
        userList.add(new User(2L, "and", "123456"));
        userList.add(new User(3L, "fx", "123456"));
    }
}
